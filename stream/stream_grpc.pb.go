...
type GreeterClient interface {
	Single(ctx context.Context, in *StreamReqData, opts ...grpc.CallOption) (*StreamResData, error)
...
func (c *greeterClient) Single(ctx context.Context, in *StreamReqData, opts ...grpc.CallOption) (*StreamResData, error) {
	out := new(StreamResData)
	err := c.cc.Invoke(ctx, "/protoc.Greeter/Single", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *greeterClient) GetStream(ctx context.Context, in *StreamReqData, opts ...grpc.CallOption) (Greeter_GetStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &Greeter_ServiceDesc.Streams[0], "/protoc.Greeter/GetStream", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *greeterClient) PutStream(ctx context.Context, opts ...grpc.CallOption) (Greeter_PutStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &Greeter_ServiceDesc.Streams[1], "/protoc.Greeter/PutStream", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *greeterClient) AllStream(ctx context.Context, opts ...grpc.CallOption) (Greeter_AllStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &Greeter_ServiceDesc.Streams[2], "/protoc.Greeter/AllStream", opts...)
	if err != nil {
		return nil, err
	}
...
type GreeterServer interface {
	Single(context.Context, *StreamReqData) (*StreamResData, error)
...
func (UnimplementedGreeterServer) Single(context.Context, *StreamReqData) (*StreamResData, error) {
...
func _Greeter_Single_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StreamReqData)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GreeterServer).Single(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protoc.Greeter/Single",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreeterServer).Single(ctx, req.(*StreamReqData))
	}
...
var Greeter_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Single",
			Handler:    _Greeter_Single_Handler,
		},
	},
